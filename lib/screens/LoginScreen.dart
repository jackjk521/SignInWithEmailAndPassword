...
class LoginScreenState extends State<LoginScreen> {
  ...
  loginWithEmailAndPassword() async {
    try {
      ...
      LocalStorageService.setName(userCred.user.displayName);
      LocalStorageService.setUid(userCred.user.uid);
      LocalStorageService.setRefreshToken(userCred.user.refreshToken);
